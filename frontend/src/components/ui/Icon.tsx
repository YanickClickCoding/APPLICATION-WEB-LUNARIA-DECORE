...
const PATHS: Record<string, string> = {
  ...
  facebook:'M14 8h2.5V5H14c-2 0-3.5 1.4-3.5 3.4V11H8v3h2.5v6h3v-6H16l.5-3h-3V8.6c0-.4.3-.6.5-.6z',
  tiktok:  'M14 4c.3 2 1.8 3.6 3.8 3.9v2.6c-1.3 0-2.6-.4-3.8-1.1v5.7a4.9 4.9 0 11-4.9-4.9c.3 0 .5 0 .8.1v2.7a2.2 2.2 0 102.2 2.2V4z',
  whatsapp:'M12 3a8.8 8.8 0 00-7.6 13.3L3 21l4.8-1.3A8.8 8.8 0 1012 3zM8.6 7.8c.2 0 .4 0 .5.4l.7 1.6c.1.2 0 .4-.1.5l-.5.6c-.1.1-.2.3 0 .5.5.9 1.4 1.7 2.4 2.1.2.1.4.1.5 0l.6-.7c.1-.2.3-.2.5-.1l1.6.8c.2.1.3.3.3.4 0 1-.8 1.8-1.7 1.8-2.8 0-6.1-3.3-6.1-6.1 0-.9.7-1.7 1.5-1.8z',
}
